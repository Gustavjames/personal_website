          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="inline-flex items-center justify-center px-8 py-4 bg-green-600 text-black font-bold rounded-lg hover:bg-green-500 transition-all duration-300 hacker-glow"
              >
                &gt; VIEW_PROJECTS
              </a>
              <a
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="w-80 h-80 glass rounded-3xl p-8 hacker-glow">
              <div className="text-center">
                <div className="w-32 h-32 bg-gradient-to-br from-green-400 to-cyan-400 rounded-full mx-auto mb-6 flex items-center justify-center hacker-glow">
